    ...
    public class ArticuloNegocio 
    {
        ...
        public List<Articulo> listar(string id = "")
        {
            ...
            try
            {
                ...
                if (id != "")
                {
                    datos.SetearConsulta("Select A.Id as IdArticulo,Codigo, Nombre ,A.Descripcion, ImagenUrl,C.Descripcion as Categoria,M.Descripcion as Marca , Precio, C.Id as IdCategoria, M.Id as IdMarca  from ARTICULOS A, CATEGORIAS C, MARCAS M where A.IdCategoria = C.Id and A.IdMarca = M.Id  and A.Id = " + id);
        ...
        public void Actualizar(Trainee trainee)
        {
            ...
            try
            {
                ...
                datos.SetearParametro("@FechaNacimiento", trainee.FechaNacimiento);
        ...
        public bool ValidarSoloLetras(string input)
        {          
